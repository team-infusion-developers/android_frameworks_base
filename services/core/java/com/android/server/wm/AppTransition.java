...
public class AppTransition implements Dump {
    ...
    static final int DEFAULT_APP_TRANSITION_DURATION = 160;
     ...
     */
    private static final int MAX_CLIP_REVEAL_TRANSITION_DURATION = 210;
    private static final int THUMBNAIL_APP_TRANSITION_DURATION = 210;
